...
const addBackground = root => {
  ...
  instructions.innerText =
    "Luna is a smol dog with a lot of BARK and BITE.  \nHenri is a menacing cat that lives nextdoor to Luna. \nIn typical cat fashion, Henri enjoys tormenting Luna.  \nUse the left / right arrow keys to navigate Luna - avoid Henri the cat!";
  const background = document.createElement("div");
  background.style.backgroundColor = "pink";
  background.style.fontFamily = "andale mono";
  background.appendChild(instructions);
  whiteBox.appendChild(background);
